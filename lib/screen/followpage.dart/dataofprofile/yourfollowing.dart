...
class FollowingDetais extends StatefulWidget {
  const FollowingDetais({Key? key}) : super(key: key);

  @override
  _FollowingDetaisState createState() => _FollowingDetaisState();
}

class _FollowingDetaisState extends State<FollowingDetais> {
  List<Map> data = [
    {
      "logo":
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appbar(title: "Following", iconData: Icons.more_vert),
      body: Column(
        children: [
